...
describe "InsuranceCalculations" do
  ...
  before do
    ...
    @setting_1_old = @country.insurance_settings.create(shortcode: "LEL", name: "Lower Earnings Limit", weekly_milestone: 75, 
    										monthly_milestone: 300, annual_milestone: 3600, effective_date: Date.today - 550.days)	
    @setting_2_old = @country.insurance_settings.create(shortcode: "PT", name: "Primary Threshold", weekly_milestone: 150, 
    										monthly_milestone: 600, annual_milestone: 7200, effective_date: Date.today - 550.days)
        ...
        describe "insurance rates for employees" do
          ...
          describe "current rates" do
            ...
            describe "index page" do
              ...
              it { should have_selector('.itemlist', value: @rate.threshold.monthly_milestone) }
              it { should have_selector('.itemlist', value: @rate.ceiling.monthly_milestone) }
          ...
          describe "future rates" do
            ...
            describe "index page" do
              ...
              it { should have_selector('.itemlist', value: @future_rate.threshold.monthly_milestone) }
              it { should have_selector('.itemlist', value: @future_rate.ceiling.monthly_milestone) }
            ...
            describe "adding a single new insurance rate" do
              ...
              describe "with a new current rate" do
                ...
                it "should create a new insurance rate for the country" do
                  ...
                  page.should have_selector('h1', text: 'Insurance Rate')
              ...
              describe "with a replacement rate in current records" do
                ...
                it "should replace the old insurance rate for the country" do
                  expect { click_button "Create" }.to change(@country.insurance_rates, :count).by(1)
                  page.should have_selector('h1', text: 'Current Insurance Rates - Employees')
                  page.should have_selector('.itemlist', value: 10.699)
                  page.should_not have_selector("li##{@rate.id}")   #cf line 469 - old value is replaced
                end
              end
              ...
              describe "with valid historic data" do
                ...
                before do
                  ...
                  click_button "Create"   
                  select "A - Default employee", from: "Insurance code"
                  select "LEL ( >GBP 300, effective", from: "Salary threshold"
