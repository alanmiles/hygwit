...
describe "GrievancePages" do
  ...
  before do
    ...
    @grievance_cat = @business.grievance_cats.create(grievance: "No reviews")
  end
  ...
  describe "logged in"do
    ...
    describe "business admin, with access to Settings" do
      ...
      before do
        ...
        @grievance_cat_2 = @business.grievance_cats.create(grievance: "Underpaid") 
      ...
      describe "index page" do
        ...
        describe "no delete link for grievance_cats that have already been used" do
          ...
          #it { should_not have_link('del', href: grievance_cat_path(@grievance_cat_2)) }
        end
