class InsuranceThresholdsController < ApplicationController
  ...
  def create
    ...
    if @eff_date.nil? || @eff_date.empty?
      ...
      flash[:success] = "This is a list of the new salary thresholds for insurance 
         starting #{@eff_date.to_date.strftime("%d %b %Y")}. Complete the update by adjusting the threshold values."
