module CountriesHelper
  ...
  def non_admin
    ...
    or if you spot a mistake in the set-up, please email us at lead@hroomph.com and tell us more."
  end
  ...
  def admin_incomplete
    ...
    with the Labor Law, now and in the future.  When you're sure everything is OK, please email us at lead@hroomph.com 
